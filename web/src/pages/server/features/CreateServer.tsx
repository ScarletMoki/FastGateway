                    ...
                    >
                        ...
                        <TabsContent value="limits" className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    <FieldLabel
                                        htmlFor="create-server-max-connections"
                                        label="入站连接上限"
                                        tooltip="当前网关允许同时保持的 Kestrel 入站连接数。留空表示不限制。"
                                    />
                                    <Input
                                        id="create-server-max-connections"
                                        type="number"
                                ...
                                <div className="space-y-2">
                                    <FieldLabel
                                        htmlFor="create-server-max-upgraded-connections"
                                        label="升级连接上限"
                                        tooltip="WebSocket 等升级连接的并发上限。留空表示不限制。"
                                    />
                                    <Input
                                        id="create-server-max-upgraded-connections"
                                        type="number"
